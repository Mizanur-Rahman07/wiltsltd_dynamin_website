                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarProjects">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/celebrate_list') ?>" class="nav-link" data-key="t-overview"> Celebrate </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/production_list') ?>" class="nav-link" data-key="t-create-project">Production </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/capabilities_list') ?>" class="nav-link" data-key="t-create-project">Capabilities </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/current_offer_list') ?>" class="nav-link" data-key="t-create-project">Current Offer </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/partner_list') ?>" class="nav-link" data-key="t-create-project">Our Partner </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Home/banner_list') ?>" class="nav-link" data-key="t-create-project">Banner </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarTasks">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Footer/about_list') ?>" class="nav-link" data-key="t-products">  Footer About </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Footer/company_list') ?>" class="nav-link" data-key="t-product-Details"> Footer Company  </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('admin/Footer/contact_list') ?>" class="nav-link" data-key="t-product-Details"> Footer Contact  </a>
                                    </li>
