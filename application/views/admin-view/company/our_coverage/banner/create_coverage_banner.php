                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 mr-4">Our Coverage Form</h4>
                            <h4 class="card-title mb-0  flex-grow-1"><a href="<?php echo base_url('admin/company/OurCoverage/coverage_banner_list') ?>" class="text-black"> Back to List-></a></h4>
                                ...
                                <form action="" method="POST" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="py-2 ">
                                            ...
                                            <?php if (!empty($coverage_banner_img)) { ?>
                                                <img src="<?php echo base_url('backend_design/uploads/') . $coverage_banner_img; ?>" style="width:100px; height: 100px;">
                                            <?php } ?>
                                            <input type="file" value="<?php echo set_value('coverage_banner_img', $coverage_banner_img); ?>" name="coverage_banner_img" class="input-file uniform_on" id="fullnameInput" placeholder="Enter your name">
                                        </div>
