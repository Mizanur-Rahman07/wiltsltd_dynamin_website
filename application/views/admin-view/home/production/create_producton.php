                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 mr-4">Production Form</h4>
                            <h4 class="card-title mb-0  flex-grow-1"><a href="<?php echo base_url('admin/Home/production_list') ?>" class="text-black"> Back to List-></a></h4>
                            ...
                            <div class="live-preview">
                                <form action="" method="POST" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="py-2 ">
                                            <label for="fullnameInput" class="form-label">Product Image</label>
                                            <?php if (!empty($product_img)) { ?>
                                                <img src="<?php echo base_url('backend_design/uploads/') . $product_img; ?>" style="width:100px; height: 100px;">
                                            <?php } ?>
                                            <input type="file" value="<?php echo set_value('product_img', $product_img); ?>" name="product_img" class="input-file uniform_on" id="fullnameInput" placeholder="Enter your name">
                                        </div>
