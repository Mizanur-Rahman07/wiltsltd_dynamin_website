                ...
                <div class="col-xxl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 mr-4">Current Form</h4>
                            <h4 class="card-title mb-0  flex-grow-1"><a href="<?php echo base_url('admin/Home/current_offer_list') ?>" class="text-black"> Back to List-></a></h4>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="py-2 ">
                                            ...
                                            <?php if (!empty($current_img)) { ?>
                                                <img src="<?php echo base_url('backend_design/uploads/') . $current_img; ?>" style="width:100px; height: 100px;">
                                            <?php } ?>
                                            <input type="file" value="<?php echo set_value('current_img', $current_img); ?>" name="current_img" class="input-file uniform_on" id="fullnameInput" placeholder="Enter your name">
                                        </div>
